      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-10">
        <div className="bg-white p-5 rounded-xl shadow text-center">
          ...
          <p className="text-2xl font-bold text-green-700">
            KES {totalMain.toLocaleString()}
          </p>
        </div>
        <div className="bg-white p-5 rounded-xl shadow text-center">
          <p className="text-gray-600">Children Min.</p>
          <p className="text-2xl font-bold text-blue-600">
            KES {totalChildren.toLocaleString()}
          </p>
        </div>
        <div className="bg-white p-5 rounded-xl shadow text-center">
      ...
      <div className="bg-white p-4 rounded-xl shadow mb-6 space-y-4">
        ...
        <div className="flex flex-wrap gap-3 mb-4">
          ...
          <button
            ...
            className="bg-pink-600 text-white px-6 py-3 rounded-lg hover:bg-gray-900"
          >
            + Add Expenditure
          </button>

          <button
            onClick={() => exportPdf({ start: startDate, end: endDate })}
            className="flex-1 sm:flex-auto min-width[120px] bg-pink-600 text-white px-4 py-2 rounded-lg"
          >
            Export PDF
          </button>
          <button
            onClick={() => exportDocx({ start: startDate, end: endDate })}
            className="flex-1 sm:flex-auto min-width[120px] bg-pink-600 text-white px-4 py-2 rounded-lg"
          >
            Export Word
          </button>
                  ...
                  {editingKey === key ? (
                    <>
                      ...
                      <td>
                        <input
                          type="number"
                          value={editForm.main_church || ""}
                          onChange={(e) =>
                            setEditForm({
                              ...editForm,
                              main_church: e.target.value,
                            })
                          }
                      ...
                      <td>
                        <input
                          type="number"
                          value={editForm.children_ministry || ""}
                          onChange={(e) =>
                            setEditForm({
                              ...editForm,
                              children_ministry: e.target.value,
                            })
                          }
                          className="w-24 text-right"
                          disabled={entry.type !== "income"}
                      ...
                      <td>
                        <input
                          ...
                          disabled={entry.type !== "expenditure"}
                        />
                      </td>
                    ...
                    <>
                      ...
                      <td className="px-6 py-4 text-right font-medium">
                        {entry.type === "income"
                          ? `KES ${(entry.main_church || 0).toLocaleString()}`
                          : "—"}
                      </td>
                      <td className="px-6 py-4 text-right font-medium">
                        {entry.type === "income"
                          ? `KES ${(
                              entry.children_ministry || 0
                            ).toLocaleString()}`
                          : "—"}
                      </td>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-8 max-w-md w-full">
            ...
            <div className="space-y-4">
              ...
              />
              <select
                value={incomeForm.service_type}
                onChange={(e) =>
                  setIncomeForm({ ...incomeForm, service_type: e.target.value })
                }
                className="w-full px-4 py-2 border rounded-lg"
              >
              ...
              <input
                ...
                value={incomeForm.main_church}
                onChange={(e) =>
                  setIncomeForm({ ...incomeForm, main_church: e.target.value })
                }
                className="w-full px-4 py-2 border rounded-lg"
              />
              <input
                type="number"
                placeholder="Children Ministry Amount"
                value={incomeForm.children_ministry}
                onChange={(e) =>
                  setIncomeForm({
                    ...incomeForm,
                    children_ministry: e.target.value,
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-8 max-w-md w-full">
            ...
            <div className="space-y-4">
              ...
              <input
                type="text"
                placeholder="Details (e.g. Rent, Electricity, etc.)"
                value={expenseForm.details}
                onChange={(e) =>
                  setExpenseForm({ ...expenseForm, details: e.target.value })
                }
                className="w-full px-4 py-2 border rounded-lg"
              />
            </div>
            <div className="flex justify-end gap-4 mt-8">
              ...
              <button
                ...
                className="px-6 py-2 bg-pink-600 text-white rounded-lg hover:bg-gray-900"
              >
                Save Expenditure
              </button>
            </div>
